...
namespace paddle {
    namespace framework {
        ...
        public:
            ...
            static bool GetValue(const std::unordered_map<std::string, std::string> &config,
        ...
        template<typename val_type>
        bool CipherUtils::GetValue(const std::unordered_map<std::string, std::string> &config,
                                   const std::string &key, val_type *output) {
