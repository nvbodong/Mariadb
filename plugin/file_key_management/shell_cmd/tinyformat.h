...
#define TINYFORMAT_ARGTYPES_16                                                                \
    class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9, \
        class T10, class T11, class T12, class T13, class T14, class T15, class T16
...
#define TINYFORMAT_VARARGS_10                                                           \
    const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, \
        const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10
#define TINYFORMAT_VARARGS_11                                                           \
    const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, \
        const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11
#define TINYFORMAT_VARARGS_12                                                           \
    const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, \
        const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11, const T12 &v12
            ...
            namespace detail {
                ...
                public:
                    ...
                    FormatArg(const T &value)    // NOLINT
                            : m_value(static_cast<const void *>(&value)), m_formatImpl(&formatImpl < T > ),
                ...
                private:
                    template<typename T>
                    static void formatImpl(std::ostream &out, const char *fmtBegin, const char *fmtEnd,
                    ...
                    void (*m_formatImpl)(std::ostream &out, const char *fmtBegin, const char *fmtEnd,
                                         int ntrunc, const void *value);
                ...
                inline const char *streamStateFromFormat(std::ostream &out,                 // NOLINT
                    ...
                    out.unsetf(std::ios::adjustfield | std::ios::basefield | std::ios::floatfield
                               | std::ios::showbase | std::ios::boolalpha | std::ios::showpoint
            ...
            namespace detail {
                ...
                public:
                    ...
                    FormatListN(const Args &... args)    // NOLINT
                            : FormatList(&m_formatterStore[0], N), m_formatterStore{FormatArg(args)...} {
